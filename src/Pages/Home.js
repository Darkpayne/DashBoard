...
const Home = () => {
  return (
    ...
    style={{ 
      backgroundImage: `url("/assets/blurbg-preview.png")`,
      ...
      backgroundPosition: 'center',
        ...
        <div className="lg:container lg:mx-auto">
            <div className="flex justify-center my-5 md:text-4xl text-2xl text-center font-semibold">
                <h1 className='capitalize '>Welcome To <span className='text-blue-700'>Abili integrated Service</span>  dashboard</h1>
            </div>
